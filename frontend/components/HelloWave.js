...
function HelloWave() {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_reanimated_1.default.View, { style: animatedStyle, children: (0, jsx_runtime_1.jsx)(ThemedText_1.ThemedText, { style: styles.text, children: "\uD83D\uDC4B" }) }));
}
