...
function ParallaxScrollView({ children, headerImage, headerBackgroundColor, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(ThemedView_1.ThemedView, { style: styles.container, children: (0, jsx_runtime_1.jsxs)(react_native_reanimated_1.default.ScrollView, { ref: scrollRef, scrollEventThrottle: 16, scrollIndicatorInsets: { bottom }, contentContainerStyle: { paddingBottom: bottom }, children: [(0, jsx_runtime_1.jsx)(react_native_reanimated_1.default.View, { style: [
                        styles.header,
                        { backgroundColor: headerBackgroundColor[colorScheme] },
                        headerAnimatedStyle,
                    ], children: headerImage }), (0, jsx_runtime_1.jsx)(ThemedView_1.ThemedView, { style: styles.content, children: children })] }) }));
}
